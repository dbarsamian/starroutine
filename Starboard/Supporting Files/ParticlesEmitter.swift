...
extension ParticlesEmitter {
    func emitterSize(_ size: CGSize) -> Self {
        return ParticlesEmitter(center: center, emitterSize: size, shape: shape, cells: cells)
    }
    
    func emitterPosition(_ position: CGPoint) -> Self {
        return ParticlesEmitter(center: position, emitterSize: emitterSize, shape: shape, cells: cells)
    }
    
    func emitterShape(_ shape: CAEmitterLayerEmitterShape) -> Self {
        return ParticlesEmitter(center: center, emitterSize: emitterSize, shape: shape, cells: cells)
    }
}
...
class EmitterCell: CAEmitterCell {
    ...
    func copyEmitter() -> EmitterCell {
        return super.copy() as? EmitterCell ?? EmitterCell()
    }
}
...
extension EmitterCell {
    ...
    @inlinable func content(_ content: Content) -> Self {
        contents = content.image.cgImage
        return self
    }
...
private extension EmitterCell.Content {
    var image: UIImage {
        switch self {
